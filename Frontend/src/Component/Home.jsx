      ...
      <div className=" w-full bg-white  ">
        <div className="">
          <div className=" fixed w-full bg-white">
            <div
              className={` z-20  pt-9 flex mx-auto w-11/12 justify-between items-center flex-wrap `}
            >
              <div className="">
                <Nav_start />
              </div>
              ...
              <div className={`${isScrolled ? "w-4/12" : "w-8/12"}`}>
                <div>
                  ...
                  <div className="">
                    <div
                      className={` bg-white    relative shadow-lg  h-16 border-2  w-[784px] mx-auto rounded-r-[30px] rounded-l-[30px]   ${
                        isScrolled ? "hidden" : ""
                      }`}
                    >
                      <button className="w-[260px] bordersks focus:bg-white focus:shadow-xl h-full hover:bg-[#EBEBEB]  hover:rounded-r-[30px] hover:rounded-l-[28px] focus:rounded-r-[30px] focus:rounded-l-[30px]">
                      ...
                      <button className="w-[130px] bordersk h-full hover:bg-[#EBEBEB] hover:rounded-r-[30px] hover:rounded-l-[30px] ">
                        <p>Check in</p>
                        <p>Add dates</p>
                      </button>
                      <button className="w-[130px] borderthird h-full hover:bg-[#EBEBEB] hover:rounded-r-[30px] hover:rounded-l-[30px]">
                        <p>Check Out</p>
                        <p>Add dates</p>
                      </button>

                      <button className="  w-[260px] border2 h-full hover:bg-[#EBEBEB] hover:rounded-r-[28px] hover:rounded-l-[30px]">
                        <p className="text-left pl-2">
                          shihab <br /> Add guest
                        </p>
                      </button>
                      <button className="bg-red-500  rounded-full texts p-3 absolute top-3 right-8 ">
                  ...
                  <div
                    ...
                    className={`flex  bg-white justify-between items-center text-lg ${
                      isScrolled ? "" : "hidden"
                    }`}
                  >
        ...
        <div className=" bg-red-500">
          <h1>
            ...
            simply because it is pain..." What is Lorem Ipsum? Lorem Ipsum is
